...
- General Mission reviewer selection for declared worker-evaluated criteria is native, owner-scoped, encrypted, replay-safe, and required before reviewer execution. Native high-risk/conflicting-evidence policy composition, reviewer-provider validation, and packaged/live-provider observation remain release gates.
