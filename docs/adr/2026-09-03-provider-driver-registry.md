...
Anthropic, xAI, DeepSeek, OpenRouter, and custom OpenAI-compatible connections. Provider families
...
Direct OpenAI, Anthropic, xAI, DeepSeek, OpenRouter and custom OpenAI-compatible text/tool turns use
