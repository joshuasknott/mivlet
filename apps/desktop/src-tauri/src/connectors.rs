...
const CATALOG: &[ConnectorCatalogEntry] = &[
    ConnectorCatalogEntry {
        ...
        setup_message: "Register a GitHub App and configure the Arden auth broker.",
...
fn action_policy(action: &str) -> Option<ConnectorActionPolicy> {
    let policy = match action {
        "github.draft-pull-request" => ConnectorActionPolicy {
            ...
            mode: "trusted-scope",
            risk_level: "medium",
            consequence: "Creates a draft pull request after Arden approval.",
        ...
        "github.comment" => ConnectorActionPolicy {
            ...
            mode: "trusted-scope",
            risk_level: "medium",
            consequence: "Publishes a comment to the selected GitHub item after Arden approval.",
            confirmation_phrase: None,
        },
        ...
        "google-calendar.create-draft" => ConnectorActionPolicy {
            ...
            mode: "trusted-scope",
            risk_level: "medium",
            consequence: "Creates a calendar event after Arden approval.",
            confirmation_phrase: None,
        },
        "google-calendar.update-draft" => ConnectorActionPolicy {
            ...
            mode: "trusted-scope",
            risk_level: "medium",
            consequence: "Updates the selected calendar event after Arden approval.",
            confirmation_phrase: None,
        },
        _ => return None,
    };
