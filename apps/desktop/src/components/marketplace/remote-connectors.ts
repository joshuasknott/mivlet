...
/** Routes retired from the active registry. Saved `marketplace-*` server
 * configurations are ignored, never deleted, and remain removable by the user
 * in advanced Settings; unrelated records are untouched. */
