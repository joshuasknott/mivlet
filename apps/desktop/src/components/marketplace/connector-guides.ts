export const connectorGuides: Record<string, { description: string; examples: string[] }> = {
  ...
  "google-drive": { description: "Bring files shared with Mivlet into your conversation.", examples: ["Find the project brief in my connected files.", "Summarize this document.", "Compare the requirements in these two files."] },
  ...
  notion: { description: "Work with the pages and databases you share with Mivlet.", examples: ["Find the project plan in my shared pages.", "Summarize this Notion page.", "Turn these notes into a concise briefing."] },
