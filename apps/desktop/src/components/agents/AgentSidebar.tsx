  ...
  return (
    ...
    >
      ...
      <div className="agent-sidebar__scopes">
        ...
        {search && !visibleAgents.length && !visibleProjects.length ? <p className="agent-list__empty">No projects or agents found. Search conversation titles in History.</p> : null}
      </div>
      <button
