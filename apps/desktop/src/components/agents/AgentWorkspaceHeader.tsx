    ...
    <header className="agent-workspace-header">
      ...
      <div className="agent-workspace-header__actions">
        ...
        <button
          ...
          aria-label={attentionCount ? `Open work panel, ${attentionCount} needs attention` : "Open teammate computer"}
          title={attentionCount ? `${attentionCount} approval${attentionCount === 1 ? "" : "s"} waiting` : "Teammate computer"}
        >
