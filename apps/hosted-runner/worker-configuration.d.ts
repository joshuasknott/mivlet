/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: ba3ee22ffa618d8af62ec1c868ab8c68)
// Runtime types generated with workerd@1.20260625.1 2026-08-25 nodejs_compat
interface __BaseEnv_Env {
	MYBROWSER: BrowserRun;
	AI: Ai;
	FABLE_HOSTED_RUNNER_API_KEY: string;
	Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
	COMPUTER_AUTHORITY: DurableObjectNamespace<import("./src/index").ComputerAuthority>;
	BROWSER_AUTHORITY: DurableObjectNamespace<import("./src/index").BrowserAuthority>;
	AGENT_ROUTINE_AUTHORITY: DurableObjectNamespace<import("./src/index").AgentRoutineAuthority>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "ComputerAuthority" | "BrowserAuthority" | "AgentRoutineAuthority";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FABLE_HOSTED_RUNNER_API_KEY">> {}
}
