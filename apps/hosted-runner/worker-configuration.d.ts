/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 40c68cd42b6cc7d51c0e9f5bb5faaea7)
// Runtime types generated with workerd@1.20260625.1 2026-08-28 nodejs_compat
interface __BaseEnv_Env {
  MYBROWSER: BrowserRun;
  MIVLET_HOSTED_RUNNER_API_KEY: string;
  MIVLET_HOSTED_RUNNER_SIGNING_KEY: string;
  ...
  >;
  BROWSER_AUTHORITY: DurableObjectNamespace<
    import("./src/index").BrowserAuthority
  >;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/index");
    durableNamespaces: "Sandbox" | "ComputerAuthority" | "BrowserAuthority";
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "MIVLET_HOSTED_RUNNER_API_KEY" | "MIVLET_HOSTED_RUNNER_SIGNING_KEY">
  > {}
}
