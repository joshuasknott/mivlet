/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=staging` (hash: 298f36a55c095ae8e78e576a728b3283)
...
interface __BaseEnv_Env {
	...
	BROKER_PENDING: DurableObjectNamespace<import("./src/worker").BrokerPending>;
	BROKER_HANDOFF: DurableObjectNamespace<import("./src/worker").BrokerHandoff>;
	BROKER_RATELIMIT: DurableObjectNamespace<import("./src/worker").BrokerRateLimit>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "BrokerPending" | "BrokerHandoff" | "BrokerRateLimit";
	}
