  ...
  "connection-read": {
    ...
    parameters: JSON.stringify({
      ...
      properties: {
        capability: {
          type: "string",
          enum: ["source.repository.list", "source.file.search", "knowledge.content.search", "communication.email.search", "communication.channel.list", "software.deployment.list", "work.issue.list"]
        },
